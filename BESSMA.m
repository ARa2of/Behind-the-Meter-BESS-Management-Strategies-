...
Prog=3;  %1 for the conventional rule-based method (CRBA), 2 for the proposed day-ahead scheduling (PDSA), 3 for the proposed rule-based algorithm (PRBA) 
...
PRP=[ones(1,(TD/24)*1)*HR ones(1,(TD/24)*7)*LR ones(1,(TD/24)*16)*HR]; %Tariff Profile
